            ...
            <div className={position ? 'pisi posisi' :'pisi'}>
                <div className=" items-center mx-auto bg-hidder">
                    <nav className=" grid grid-35-65 justify-between gap-0 px-2 me:items-center md:px-2 sm:px-6 sm:grid-35-65">
                        <div className="text-2xl font-light text-slate-100">Gufanto<span className="text-green-600 Dev">Dev</span></div>
                        <div className={location}>
                            <ul className="flex gap-4 text-lg items-center md:flex-row md:bg-transparent md:py-0 xs:flex-col xs:py-3">
                                ...
                                <li><button className="text-gray-100 transition-all duration-500 hover:text-green-600 focus:outline-0">Contect</button></li>
                            </ul>
                        </div>
                        <span className="material-symbols-outlined text-4xl self-center text-slate-100 justify-self-end button md:relative xs:absolute"  onClick={setButton}>menu</span>
                    </nav>
                </div>
            </div>
        </section>
